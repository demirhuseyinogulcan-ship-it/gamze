 ...
 * Full-screen hero section for service pages with parallax effect
 * Based on LocationHero but optimized for service pages
 */

import { motion } from 'framer-motion';
import Image from 'next/image';
import type { ServiceHeroProps } from '@/types/service';
        ...
        >
            ...
            <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <motion.p
                        variants={itemVariants}
                        className="mx-auto mb-4 max-w-2xl text-xl font-light leading-relaxed text-cream sm:text-2xl md:text-3xl"
                    >
                        {tagline}
                    </motion.p>
                    ...
                    <motion.p
                        variants={itemVariants}
                        className="mx-auto mb-8 max-w-3xl text-base font-light leading-relaxed text-cream/70 sm:text-lg"
                    >
                        {description}
                    </motion.p>
