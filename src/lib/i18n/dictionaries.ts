  ...
  tr: {
    ...
    services: {
      ...
      items: [
        ...
        {
          id: 'group',
          title: 'Grup Tango Dersleri',
          description: 'Sosyal ortamda, eğlenceli atmosferde tango öğrenin. Her seviyeye uygun grup dersleri.',
          features: ['Sosyal öğrenme ortamı', 'Uygun fiyat seçenekleri', 'Farklı partnerlerle pratik', 'Eğlenceli atmosfer'],
          href: '/grup-tango-dersi',
        },
        {
          id: 'couple',
          title: 'Çift Tango Dersleri',
          description: 'Partnerinizle birlikte tangonun romantik dünyasına adım atın.',
          features: ['Partner uyumu geliştirme', 'İletişim güçlendirme', 'Romantik deneyim', 'Özel koreografi'],
          href: '/cift-tango-dersi',
        },
        {
          id: 'trial',
          title: 'Deneme Dersi',
          description: 'Tango dünyasını keşfetmek için ilk adımınızı atın. Ücretsiz deneme dersi fırsatı.',
          features: ['Bağlayıcılık yok', 'Temel adımlar tanıtımı', 'Seviye belirleme', 'Ücretsiz katılım'],
      ...
      items: [
        {
          ...
          href: '/en/private-tango-lessons',
        },
        {
          id: 'group',
          title: 'Group Tango Lessons',
          description: 'Learn tango in a social environment with a fun atmosphere. Group classes for all levels.',
          features: ['Social learning environment', 'Affordable pricing', 'Practice with different partners', 'Fun atmosphere'],
          href: '/en/group-tango-lessons',
        },
        {
          id: 'couple',
          title: 'Couple Tango Lessons',
          description: 'Step into the romantic world of tango together with your partner.',
          features: ['Partner harmony development', 'Communication strengthening', 'Romantic experience', 'Custom choreography'],
          href: '/en/couple-tango-lessons',
        },
        {
          id: 'trial',
          title: 'Trial Lesson',
          description: 'Take your first step to discover the world of tango. Free trial lesson opportunity.',
          features: ['No commitment', 'Basic steps introduction', 'Level assessment', 'Free participation'],
          href: '/en/tango-trial-lesson',
        },
        {
          id: 'wedding',
          title: 'Wedding Dance',
